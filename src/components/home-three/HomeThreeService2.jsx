                ...
                <div className="container">
                    <div className="section-title-area text-center">
                        ...
                        <p
                            ...
                            data-sal-duration={800}
                        >
                            Your first website to Cloud ways from any web host for without breaking
                            your live site hosted.
                        </p>
                    </div>
                    <div className="section-inner">
                        <div className="row  g-5">
                            ...
                            >
                                <div className="service-wrapper">
                                    ...
                                    <div className="content">
                                        ...
                                        <Link to="/cloud-hosting" className="view-more-btn">
                            ...
                            >
                                <div className="service-wrapper">
                                    ...
                                    <div className="content">
                                        ...
                                        <Link to="/wordpress-hosting" className="view-more-btn">
                                            View More <i className="fa-regular fa-arrow-right" />
                                        </Link>
                                    </div>
                                    <div className="wrapper-shape">
                            ...
                            >
                                <div className="service-wrapper">
                                    ...
                                    <div className="content">
                                        <h4 className="title">Dedicated Hosting</h4>
                                        <p className="desc">
                                            WordPress Hosting gives speed performance with full features.
                                        </p>
                                        <Link to="/dedicated-hosting" className="view-more-btn">
                                            View More <i className="fa-regular fa-arrow-right" />
                                        </Link>
                                    </div>
                                    <div className="wrapper-shape">
                            ...
                            >
                                <div className="service-wrapper">
                                    ...
                                    <div className="content">
                                        <h4 className="title">Turbo Hosting</h4>
                                        <p className="desc">
                                            WordPress Hosting gives speed performance with full features.
                                        </p>
                                        <Link to="/wordpress-hosting" className="view-more-btn">
                            ...
                            >
                                <div className="service-wrapper">
                                    ...
                                    <div className="content">
                                        ...
                                        <Link to="/reseller-hosting" className="view-more-btn">
                                            View More <i className="fa-regular fa-arrow-right" />
                                        </Link>
                                    </div>
                                    <div className="wrapper-shape">
                            ...
                            >
                                <div className="service-wrapper">
                                    ...
                                    <div className="content">
                                        <h4 className="title">Share Hosting</h4>
                                        <p className="desc">
                                            WordPress Hosting gives speed performance with full features.
                                        </p>
                                        <Link to="/shared-hosting" className="view-more-btn">
                                            View More <i className="fa-regular fa-arrow-right" />
                                        </Link>
                                    </div>
                                    <div className="wrapper-shape">
                        ...
                        <div
                            className="section-bottom-area"
                            data-sal="slide-down"
                            data-sal-delay={1000}
                            data-sal-duration={800}
                        >
                            <h4 className="bottom-title">
                                Looking for a more hosting services? <Link to="#">Click now</Link>
                            </h4>
                        </div>
                    </div>
                </div>
...
export default HomeThreeService2