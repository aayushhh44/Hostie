					...
					{/* <div className="row align-items-end position-relative">
						<div className="col-lg-6">
							<div className="rts-hero__content w-550">
								...
								<h1 className="heading" data-sal="slide-down" data-sal-delay={300} data-sal-duration={800}>
								...
								<div className="rts-hero__content--group" data-sal="slide-down" data-sal-delay={500} data-sal-duration={800}>
							...
							<div className="rts-hero__images position-relative">
								<div className="rts-hero-main">
									<div className="image-main ">
										<img className="main top-bottom2" src="assets/images/banner/hosting-01.svg" alt="" />
									</div>
									<img className="hero-shape one" src="assets/images/banner/hosting.svg" alt="" />
								</div>
